...
# HINT: Use `wandb.init()` to start a new run.

wandb.init(project="mlops-intro", name="lesson-4-logging-experiments")  # Solution
...
wandb.config.update(hyperparameters)  # Solution
...
wandb.log({"accuracy": accuracy})  # Solution
...
artifact_original = wandb.Artifact(name="random_forest_model.pkl", type="model")
