...
wandb.init(project="credit-card-fraud-detection-1", job_type="data-drift-monitoring") 
...
def load_data(): 
    ...
    ref_artifact = wandb.use_artifact('dvalia-self-employed/credit-card-fraud-detection-1/reference_data:latest', type='dataset') 
    ...
    curr_artifact = wandb.use_artifact('dvalia-self-employed/credit-card-fraud-detection-1/original_data:latest', type='dataset') 
