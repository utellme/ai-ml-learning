...
### HELPER FUNCTIONS ###
wandb.init(project="credit-card-fraud-detection-1", name="lesson-3-3-data-cleaning")
...
def load_data():
    ...
    try:
        ...
        artifact = wandb.use_artifact('dvalia/credit-card-fraud-detection-1/original_data:latest', type='dataset')
