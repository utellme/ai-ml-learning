...
wandb.init(project="credit-card-fraud-detection-1", name="model-evaluation")
...
def evaluate_model(X, y):
    ...
    artifact = wandb.use_artifact('dvalia-self-employed/credit-card-fraud-detection-1/production_model:latest', type='model')
